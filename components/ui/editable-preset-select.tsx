...
export type EditablePresetSelectProps = {
  id?: string;
  disabled?: boolean;
...
export function EditablePresetSelect({
  id,
  disabled = false,
  presets,
  sentinelValue,
        ...
        >
          ...
          >
            ...
            <SelectPrimitive.List>
              ...
              <SelectItem value={sentinelValue}>{lastOptionLabel}</SelectItem>
            </SelectPrimitive.List>
            <SelectScrollDownButton />
          </SelectPrimitive.Popup>
        </SelectPrimitive.Positioner>
